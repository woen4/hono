import type { HttpRequest as AzureRequest, InvocationContext, HttpResponseInit as AzureResponse, HttpResponseInit } from '@azure/functions'
...
const transformHeaders = (rawHeaders: Response['headers'] | AzureRequest['headers']) => {
